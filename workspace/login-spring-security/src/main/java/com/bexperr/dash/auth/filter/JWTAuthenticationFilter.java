package com.bexperr.dash.auth.filter;
...
import com.bexperr.dash.auth.service.JWTServiceImpl;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		body.put("mensaje", String.format( "Hola %s usuario, has iniciado sesión con éxito", ((User)authResult.getPrincipal()).getUsername()));
